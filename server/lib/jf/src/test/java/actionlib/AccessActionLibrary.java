...
public class AccessActionLibrary extends SimsActionLibrary{
	SimsWebElementLocatorFromConfig webLocator = null;
	public AccessActionLibrary(WebDriver d , Properties configProperties) {
		super(d, configProperties, "ACCESS");
		this.taskApplication = "ACCESS";
	 ...
	 *
	 * @param elementName - Name of element containing text
